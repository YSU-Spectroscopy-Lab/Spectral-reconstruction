...
%% 平均最后n个光谱数据文件
file_list1 = dir('F:\课题\数据\武\SO2标准谱\2023.9.25SO2+NO\bd\*.txt');
file_list2 = dir('F:\课题\数据\武\SO2标准谱\2023.9.25SO2+NO\50SO2\*.txt');
file_list3 = dir('F:\课题\数据\武\SO2标准谱\2023.9.25SO2+NO\500SO2\*.txt');
u0=203.5;v0=230;%测量波段
u1=202;v1=232;%拟合波段
%标注浓度，测量浓度
S_C=50;M_C=500;xishu=S_C/M_C;
...
for i1=(len1-9):1:len1
    ...
    fileID1=fopen(strcat('F:\课题\数据\武\SO2标准谱\2023.9.25SO2+NO\bd\',file_list1(i1).name));
...
for i3=(len2-9):1:len2
    file_list2(i3).name;
    fileID2=fopen(strcat('F:\课题\数据\武\SO2标准谱\2023.9.25SO2+NO\50SO2\',file_list2(i3).name));
...
for i5=(len3-9):1:len3
    file_list3(i5).name;
    fileID3=fopen(strcat('F:\课题\数据\武\SO2标准谱\2023.9.25SO2+NO\500SO2\',file_list3(i5).name));
